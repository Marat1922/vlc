...
class EmptyLoadingStateView : FrameLayout {
    ...
    var state = EmptyLoadingState.LOADING
        set(value) {
            ...
            emptyImageView.setImageBitmap(context.getBitmapFromDrawable(if (value == EmptyLoadingState.EMPTY_FAVORITES) R.drawable.emptymedia else if (value in arrayOf(EmptyLoadingState.EMPTY, EmptyLoadingState.EMPTY_SEARCH, EmptyLoadingState.EMPTY_FAVORITES)) R.drawable.emptymedia else R.drawable.ic_empty_warning))
